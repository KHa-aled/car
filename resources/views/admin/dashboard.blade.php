...
<!--            <div class="span3">-->
<!--              <ul class="site-stats">-->
<!--                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$users}}</strong> <small>Total Users</small></li>-->
<!--                <li class="bg_lh"><i class="icon-plus"></i> <strong>120</strong> <small>New Users </small></li>-->
<!--                <li class="bg_lh"><i class="icon-shopping-cart"></i> <strong>656</strong> <small>Total Shop</small></li>-->
<!--                <li class="bg_lh"><i class="icon-tag"></i> <strong>{{$orders}}</strong> <small>Total Orders</small></li>-->
